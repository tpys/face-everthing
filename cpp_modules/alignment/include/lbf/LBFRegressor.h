...
//        Models_.resize(max_numstage_);
    ...
    LBFRegressor(const Params& params): params_(params){
        max_numstage_ = params.max_numstage;
        RandomForest_.resize(max_numstage_, RandomForest(params));
        Models_.resize(max_numstage_);
    }
    ...
    void Load(const std::string& lbf_path, const std::string& regressor_path);
    void Save(const std::string& lbf_path, const std::string& regressor_path);
    ...
    void WriteRegressor(std::ofstream& fout, const std::string& model_path);
    void ReadRegressor(std::ifstream& fin, const std::string& model_path);
