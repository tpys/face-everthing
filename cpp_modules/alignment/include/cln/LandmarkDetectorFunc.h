...
namespace LandmarkDetector
{
	...
	// Return the current estimate of the head pose, this can be either in utils or world coordinate space
	...
	// The pose returned can be either in utils or world coordinates
	// The format returned is [Tx, Ty, Tz, Eul_x, Eul_y, Eul_z]
